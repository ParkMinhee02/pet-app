...
const SignUpForm = () => {
	...
	const handleAllCheck = () => {
		...
		setMarkingChecked(!markingChecked);
	};
	...
	return (
		<div className='signWrap'>
			...
			<fieldset className='signUpArea'>
				<form action="#" onSubmit={handleSubmit} method='post' name='signUp'>
					<ul>
						...
						<li className="email-section">
							<div className="area-style">
								...
								<input ref={emailInputRef} type="email" id="emailArea" required size={20} value={email} onChange={(e) => {setEmail(e.target.value)}} onBlur={handleEmail} />
						...
						<li className="birth-section">
							<div className="area-style">
								...
								<input ref={birthInputRef} type="date" id="birthArea" required size={20} value={birth} onChange={(e) => {setBirth(e.target.value)}} />
						...
						<li id='terms-section'>
							...
							<p>
								...
								<input type="checkbox" id="terms-check3" className="check-style" checked={markingChecked} onChange={() => setMarkingChecked(!markingChecked)} />
